...
path_script = r'"C:\Users\Jorge.Carrillo1\Documents\DESARROLLO\VS CODE\DB_CONVERSION_REPO\db_conversion\app.py"'
...
subprocess_run_args = f"venv\Scripts\python {path_script} {directory_databases} {db_fileFormat} {output_fileformat}"
